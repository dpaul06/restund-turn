...
static int module_init(void)
{
	...
	conf_get_u32(restund_conf(), "udp_sockbuf_size", &turnd.udp_sockbuf_size);
	conf_get_u32(restund_conf(), "turn_min_udp_alloc_port", &turnd.turn_min_udp_alloc_port);
	conf_get_u32(restund_conf(), "turn_max_udp_alloc_port", &turnd.turn_max_udp_alloc_port);
	...
	restund_debug("turn: lifetime=%u ext=%j ext6=%j bsz=%u minport=%u maxport=%u\n",
		      turnd.lifetime_max, &turnd.rel_addr, &turnd.rel_addr6,
		      bsize, turnd.turn_min_udp_alloc_port, turnd.turn_max_udp_alloc_port);
